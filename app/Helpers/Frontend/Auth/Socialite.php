...
class Socialite
{
    ...
    public function getSocialLinks()
    {
        ...
        if (config('services.agave.active')) {
            $socialite_enable[] = "<a href='".route('frontend.auth.social.login', 'agave')."' class='btn btn-sm btn-outline-info m-1'><i class='fab fa-agave'></i>  ".__('labels.frontend.auth.login_with', ['social_media' => 'Agave']).'</a>';
        }
