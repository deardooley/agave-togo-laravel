...
return [
    ...
    */
    ...
    'rolesMiddlware' => env('LARAVEL_LOGGER_ROLES_MIDDLWARE', 'role:administrator'),
    ...
    */
    ...
    'defaultUserModel' => 'App\Models\Auth\User',//env('LARAVEL_LOGGER_USER_MODEL', 'App\Models\Auth\User'),
    ...
    */
    ...
    'loggerBladeExtended'       => 'backend.layouts.app',
    ...
    */
    ...
    // Font Awesome
    'enableFontAwesomeCDN'      => env('LARAVEL_LOGGER_FONT_AWESOME_CDN_ENABLED', false),
